...
| [12-metadata-privacy-controls-are-uneven.md](./12-metadata-privacy-controls-are-uneven.md) | Native tokens: the settings page warns about the pointer index and not the token registry, which is asked about more subjects, and neither can be turned off | Open, not scheduled |
